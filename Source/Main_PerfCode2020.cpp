...
//===================================================================//
	...
	//===============================================================//
        ...
        printf("CL %lf CY %lf CDi %lf  |CY+CDI| %lf\n",\
               CL,CY,CDi,sqrt(CY*CY+CDi*CDi));
        printf("CFX %lf CFY %lf CFZ %lf |CFX+CFY| %lf in Main\n",\
               CF[0],CF[1],CF[2],sqrt(CF[1]*CF[1]+CF[0]*CF[0]));
        printf("CD %lf   CL %lf  alfpha %.2lf in Main\n",\
